...
import GuidNodeNiirdccore from 'ember-osf-web/guid-node/niirdccore/controller';
import Node from 'ember-osf-web/models/node';
import { GuidRouteModel } from 'ember-osf-web/resolve-guid/guid-route';
import Analytics from 'ember-osf-web/services/analytics';

export default class GuidNodeNiirdccoreRoute extends Route.extend(ConfirmationMixin, {}) {
    @service analytics!: Analytics;

    model(this: GuidNodeNiirdccoreRoute) {
    ...
    get isPageDirty() {
        const controller = this.controller as GuidNodeNiirdccore;
